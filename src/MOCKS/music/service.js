// src/MOCKS/music/service.js
import { musicDB, getNextId } from './db.js';
...
// Export functions specifically for React Query hooks:
export const getSongs = () => musicService.getAllSongs();
export const getAlbumById = (id) => musicService.getSongById(id);
export const createSong = (songData) => musicService.createSong(songData);
